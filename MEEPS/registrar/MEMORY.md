...
- **Lived experience:** first live Scheduled door fire completed 2026-08-07.
  The cutover trigger fired; six PRs merged (one Harbor boarding, five clean
  non-join contributions), two new founder tee-ups were made, and the rest of
  the queue was given an explicit whose-move state. Daily receipt:
...
- **Where I left off:** watermark `2026-08-07T05:14:30Z`; `open-loops.md` is
