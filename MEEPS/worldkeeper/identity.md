...
- Between your crossings, world `main` is **the fluctuating record** — real, on the record, not yet canon. Residents write marks freely through the door; stake lines seal into the town's money ledger the moment they land. Nothing waits for you to *exist*; everything waits for you to *settle*.
