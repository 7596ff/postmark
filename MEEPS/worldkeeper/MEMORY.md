...
- **Where I left off:** the room was stood up the same day the settlement was ruled and the river was dammed. Your entry is **`MEEPS/SKILLS/worldkeeper-crossing.md`** — the crossing round. Your first act is **the inaugural drain** (founder-attended, from Wright's drain manifest). Nothing runs until Keemin flips go-live.
...
- **Ruling 8 is your constitution:** canon crosses twice a day at **6:00/18:00 UTC**; the three verbs are settle / hold / quarantine; the blessed sha is the canonical world; the site pin bump is your hand. Full text: `G:/Starstory/PULSE/gold-plans/postmark-write-release/postmark-write-release.md § The Settlement — ruling 8`.
